					...
					<div class="col-lg-6" data-aos="fade-up">
						<div class="single_blog">
							<div class="blog-text wow fadeInLeft">
								<h4><a href="#.">Jitendra Kumar</a></h4>
                                <h5> City:Dehradun</h5>
                                <h5>Package: &#8377; 5 Lakh </h5>
                                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.</p>
                                <center><p><a href="#" class="btn btn-primary btn-lg" style="color:white;"><i class="fa fa-shopping-cart"></i> Delete</a></p></center>
							</div>
							<img class="blog-photo" width="300" height="300" alt="" src="assets/img/blog/blog1.jpg"/>
						</div>
					</div><!--- END COL -->
					<div class="col-lg-6" data-aos="fade-up">
						<div class="single_blog">
