				...
				<div class="row text-center">		
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
							...
							<a class="btn" data-toggle="modal" data-target=".email-checker">ADD TENT</a>
						</div>
					</div><!-- END COL -->
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
							<i class="fa fa-globe"></i>
							<a class="btn" data-toggle="modal" name="removepackage">REMOVE TENT</a>
						</div>
					</div><!-- END COL -->
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                   ...
                   <h4 class="modal-title" >ADD TENT HOUSE</h4>
                </div>
