						...
						<h3>Sign Up For Your Business</h3><br>
							<form  action="joinus.php" method="post" class="form-horizontal" enctype="multipart/form-data">
								<div class="row">
									...
									<div class="row">
									<div class="form-group col-md-6">
										<input type="text" name="adhar" class="form-control" id="first-email" placeholder="Adhar Card No" required="required">
									</div>
									<div class="form-group col-md-6">
										<input type="text" name="pan" class="form-control" id="first-name" placeholder="Pan Card" required="required">
									</div>
									</div>
									<div class="form-group col-md-12">
										<label>Upload Ahdar Card</label><span><input type="file" name="pic" class="form-control" id="first-name" placeholder="Adhar Card Image" required="required"></span>
									</div>
		 ...
		 $files = preg_replace('/\s+/', '_', $file);
			...
			if($FileType != "jpg" && $FileType != "JPG" && $FileType != "png" && $FileType != "jpeg" && $FileType != "gif" )  
			{
			 ...
			 {    $filename = compress_image($temp_file, $url.$files, 10); //for compression 
					...
					$ins="insert into psignup(name,email,password,mobile,city,profession,ad_card,pan_card,a_img) values('$name','$email','$password','$mobile','$city','$pro','$adhar','$pan','$files')";
