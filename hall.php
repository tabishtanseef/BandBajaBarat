...
<html lang="en">
    ...
    <body data-spy="scroll" data-offset="80">
		...
		<!-- START WHY CHOOSE US -->	
		<section data-stellar-background-ratio="0.3" class="why_choose section-padding"  style="background-image: url(assets/img/bg/banquet.jpg); height:400px; background-size:cover; background-position: center center;">			
			<div class="container">
				<br>
				<br>
				<br>
				...
				<div class="row text-center">		
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
							...
							<a class="btn" data-toggle="modal" data-target=".email-checker">ADD BANQUET HALL</a>
						</div>
					</div><!-- END COL -->
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
							<i class="fa fa-globe"></i>
							<a class="btn" data-toggle="modal" name="removepackage">REMOVE BANQUET HALL</a>
						</div>
					</div><!-- END COL -->
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                   ...
                   <h4 class="modal-title" >Add Banquet Hall</h4>
                </div>
                <div class="modal-body">
				
				
				<form action="hall.php" method="post" enctype="multipart/form-data">
                    <input class="text-center" class="form-control"type="text" placeholder=" Name" name="p_name" id="id_email"/><br><br>
                    
					<input class="text-center" type="text" placeholder=" Price" name="p_price" id="id_email"/><br><br>
                ...
                <div class="modal-footer">
                    <input  id="btn_email" type="submit" class="btn btn-primary"  value="UPLOAD BANQUET HALL" name="submit"/>
					                </div>
									</form>
			 ...
			 echo "<script>alert('it seems your image format is not supported by our system, we are sorry for trouble!!!');</script>"; 
			  ...
			  {     $filename = compress_image($temp_file, $url.$files, 10); //for compression 
					...
					if($run_user)
					{
						...
						echo "<script>alert('redirecting'); window.location.assign('hall.php)'</script>";
					}
					else
					{
