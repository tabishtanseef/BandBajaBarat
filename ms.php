...
<html lang="en">
	...
	<head>
		...
		<!-- SITE TITLE -->
		<title>Wedding Bos| music system</title>			
    ...
    <body data-spy="scroll" data-offset="80">
        ...
        <section id="home" class="home_parallax" style="background-image: url(assets/img/bg/marriage.jpg);  background-size:cover;  height:200px; background-position: center center;">	</section>
