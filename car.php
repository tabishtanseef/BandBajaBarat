				...
				<div class="row text-center">		
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
							...
							<a class="btn" data-toggle="modal" data-target=".email-checker">ADD CARS</a>
						</div>
					</div><!-- END COL -->
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
							<i class="fa fa-globe"></i>
							<a class="btn" data-toggle="modal" name="removepackage">REMOVE CARS</a>
						</div>
					</div><!-- END COL -->
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
				...
				<form action="car.php" method="post" enctype="multipart/form-data">
                    <input class="text-center" class="form-control"type="text" placeholder=" Car Name" name="p_name" id="id_email"/><br><br>
                    
					<input class="text-center" type="text" placeholder="Car No" name="cr_no" id="id_email"/><br><br>
					
					<input class="text-center" type="text" placeholder="Car Model No" name="cr_m_no" id="id_email"/><br><br>
					
					<input class="text-center" type="text" placeholder="Car's Year" name="cr_yr" id="id_email"/><br><br>
                    
					<input class="text-center" type="text" placeholder="City" name="p_city" id="id_email"/><br><br>
                    
					<input type="text" name="p_ser" placeholder="Add Car Features"width="100px" height="50px"/><br><br>
				...
				<input class="text-center" class="form-control"type="text" placeholder=" Driver Name" name="d_name" id="id_email"/><br><br>
                    
					<input class="text-center" type="text" placeholder="Driver's Mob No" name="d_no" id="id_email"/><br><br>
					
					<input class="text-center" type="text" placeholder="Adhar Card No" name="a_no" id="id_email"/><br><br>
					
					<input class="text-center" type="text" placeholder="Driver's License No" name="l_no" id="id_email"/><br><br>
                ...
                <div class="modal-footer">
                    <input  id="btn_email" type="submit" class="btn btn-primary"  value="ADD YOUR CAR" name="submit"/>
				</div>
		        </form>
				</div>
...
//function ends here :) 
 ...
 {  $filename = compress_image($temp_file, $url.$files, 10); //for compression 
	...
	$ins = "insert into wpackage(user_id,profession,pname,price,city,service,img) values('$id','$prof','$pname','$pprice','$city','$text','$files')";
	$run_user=mysqli_query($con,$ins);
	if($run_user)
	{
		
		echo "<script>alert('your package added successfully')</script>";
		echo "<script>alert('redirecting'); window.location.assign('car.php)'</script>";
	}
	else
	{
