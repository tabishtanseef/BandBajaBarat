				...
				<div class="row text-center">		
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
							...
							<a class="btn" data-toggle="modal" data-target=".email-checker">ADD DJ PACKAGE</a>
						</div>
					</div><!-- END COL -->
					<div class="col-sm-4 col-xs-12" data-aos="fade-up">
						<div class="single-choose">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                   ...
                   <h4 class="modal-title" >Add DJ Package</h4>
                </div>
...
//move_uploaded_file($temp_file,$folder.$files);  
	...
	if($run_user)
	{
		...
		echo "<script>alert('redirecting'); window.location.assign('sound.php)'</script>";
	}
	else
	{
